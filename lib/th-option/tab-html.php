...
<div class="th-option-area">
        <div class="th-option-top-hdr">
            <div class="col-1">
                <div class="logo-img">
                <a target="_blank" href="<?php echo $theme_header['theme_brand_url']; ?>/?wp=portfoliolite" class=""> <span class="logo-image"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/lib/th-option/assets/images/icon.png"/><?php echo $theme_header['theme_brand']; ?></span></a>
            </div>
            </div>
            <div class="col-2">
                ...
                <span><?php echo _e('FREE THEME','portfoliolite'); ?></span>
            </div>
        </div>
        <div class="th-option-bottom-hdr">
            <a class="tablinks active" onclick="openTab(event, 'Welcome')"><?php _e('Welcome','portfoliolite');?></a>
            <a class="tablinks" onclick="openTab(event, 'Recommended-Plugin')"><?php _e('Recommended Plugin','portfoliolite');?> </a>

            <a class="tablinks" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Demo Import','portfoliolite');?> </a>
            
            <a class="tablinks get-child" onclick="openTab(event, 'Get-Child-Theme')"><?php _e('Get Child Theme','portfoliolite');?></a>
            <a class="tablinks" onclick="openTab(event, 'Free-Vs-Pro')"><?php _e('Free Vs Pro','portfoliolite');?></a>
            <a class="tablinks" onclick="openTab(event, 'Help')"><?php _e('Help','portfoliolite');?></a>
          ...
          <div id="Import-Demo-Content" class="tabcontent">
            ...
            <div class="rp-two-column">
                ...
                <h3><?php _e('Click Here To Import Demo Content','portfoliolite'); ?></h3>
				 ...
				 <p> <?php _e('You need to Install required plugins like- Hunk Companion, WooCommerce and One click demo import plugin. After installing required plugins import button will activate.', 'portfoliolite'); ?></p>
              <a class="button disabled importdemo"><?php _e( 'Import Demo', 'portfoliolite' ); ?></a>
